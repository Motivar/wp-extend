...
<div class="wrap">
 ...
 <form name="flx-custom-list-form" method="post">
  <input type="hidden" name="table_id" id="ewp_content_id" value="<?php echo isset($_REQUEST['id']) ? $_REQUEST['id'] : 'new'; ?>" />
  <?php wp_nonce_field($view, 'flx_list_page_hook_nonce');
