    ...
    foreach ($awm_fields as $id => $awm_field) {
      ...
      switch ($case) {
        case 'ewp_block':
          ...
          $style = (isset($awm_field['position']['style']) && !empty($awm_field['position']['style'])) ? $awm_field['position']['style'] : '';
          $script = (isset($awm_field['position']['script']) && !empty($awm_field['position']['script'])) ? $awm_field['position']['script'] : '';
          $description = (isset($awm_field['position']['description']) && !empty($awm_field['position']['description'])) ? $awm_field['position']['description'] : '';
