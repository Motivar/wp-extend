                ...
                if ($show == 1) {
                    ...
                    if ($stop != 1 && isset($n)) {
                        ...
                        switch ($view) {
                            ...
                            case 'user':
                                /*user view*/
                                $msg[] = '<tr data-input="' . $original_meta_id . '" ' . $labelAttrs . ' class="' . implode(' ', $label_class) . '" data-input="' . $original_meta_id . '" data-type="' . $a['case'] . '"><th><label for="' . $original_meta_id . '" class="awm-input-label">' . $a['label'] . '</label>' . $explanation . '</th>';
